...
printf("\n45'	Intervalo\n");
   sleep(3);
printf("\n46'	%s entra duro sobre %s.\n",jogo.jogadores_equipaB[10] ,jogo.jogadores_equipaA[5]);
   sleep(3);
...
printf("\n62'	%s faz um entrada fora de tempo ao %s.\n",jogo.jogadores_equipaA[10],jogo.jogadores_equipaB[10]);
   sleep(3);
...
fp=fopen("arouca.txt", "a+");
    ...
    sleep(3);
    printf("\n23'	%s vê %s numa posição avançada e passa-lhe a bola.\n",jogo.jogadores_equipaB[10],jogo.jogadores_equipaB[10]);
    sleep(3);
    ...
    sleep(3);
       ...
       jogo.numero_golos++;
       golos.golosMaritimo++;
       golosJogador.golosJogadorMaritimo[10]++;
...
printf("Foram mostrados %d cartões amarelos!\n", jogo.cartao_amarelo);
printf("Foram mostrados %d cartões vermelhos!\n", jogo.cartao_vermelho);
printf("Os melhores marcadores foram %s e %s com %d golos\n", jogo.jogadores_equipaA[10], jogo.jogadores_equipaA[8], golosJogador.golosJogadorMaritimo[8]);
...
fp=fopen("olhanense.txt", "a+");
    ...
    printf("\n21'	%s tem uma entrada tardia sobre %s.\n",jogo.jogadores_equipaB[10],jogo.jogadores_equipaA[9]);
       sleep(3);
...
printf("\nForam mostrados %d cartões amarelos!\n", jogo.cartao_amarelo);
printf("Foram mostrados %d cartões vermelhos!\n", jogo.cartao_vermelho);
printf("O melhor marcador foram %s, %s, %s e %s com %d golo\n", jogo.jogadores_equipaA[7], jogo.jogadores_equipaA[10], jogo.jogadores_equipaA[10], jogo.jogadores_equipaA[8], golosJogador.golosJogadorOlhanense[7]);
...
fp=fopen("braga.txt", "a+");
    ...
    printf("\n%s atira-se bem e defende-a com ambas as mãos.\n",jogo.jogadores_equipaB[0]);
    sleep(3);
    printf("\n12'	%s tem uma entrada tardia sobre %s.\n",jogo.jogadores_equipaB[8],jogo.jogadores_equipaA[10]);
    sleep(3);
...
fp=fopen("guimaraes.txt", "a+");
  ...
  printf("\n0' Ponta-pé de saída\n");
    ...
    printf("\n%s transporta a bola para a grande área e remata com força.\n",jogo.jogadores_equipaB[10]);
          sleep(3);
    printf("\n%s mergulha para o lado e defende-a.",jogo.jogadores_equipaA[0]);
        sleep(3);  
    ...
    printf("\nGOLO!! - A bola desliza para trás do guarda-redes e cai sobre a linha.\n");
     ...
     jogo.numero_golos++;
     golos.golosVitoriaGuimaraes++;
     golosJogador.golosJogadorVitoriaGuimaraes[10]++;
...
printf("\nForam mostrados %d cartões amarelos!\n", jogo.cartao_amarelo);
printf("Foram mostrados %d cartões vermelhos!\n", jogo.cartao_vermelho);
printf("Os melhores marcadores foram %s, %s e %s com %d golo\n", jogo.jogadores_equipaA[8], jogo.jogadores_equipaB[8], jogo.jogadores_equipaA[10], golosJogador.golosJogadorVitoriaGuimaraes[8]);
...
printf("\n63' %s joga uma grande bola para %s.\n",jogo.jogadores_equipaB[10],jogo.jogadores_equipaB[2]);
    sleep(3);
...
printf("\n%s  baixa-se e desvia a bola para longe.\n",jogo.jogadores_equipaB[0]);
    sleep(3);
printf("\n78'	%s faz um cruzamento preciso para %s.\n",jogo.jogadores_equipaB[3],jogo.jogadores_equipaB[10]);
    sleep(3);
printf("\n%s  desfere um tiro de longa distância.\n",jogo.jogadores_equipaB[10]);
    sleep(3);
printf("\nO guarda-redes chega-lhe com uma mão e afasta a bola da baliza.\n");
...
printf("\n%s faz a defesa.\n",jogo.jogadores_equipaA[0]);
    sleep(3);
printf("\n74'	%s cai depois de uma falta de %s.\n",jogo.jogadores_equipaB[10],jogo.jogadores_equipaA[7]);
    sleep(3);
printf("\nCartão Amarelo - O árbitro não tem outra hipótese a não ser advertir o jogador.\n");
    sleep(3);
      jogo.cartao_amarelo++;
...
printf("\n45'	 Intervalo\n");
       sleep(3);
printf("\n65'	%s derruba %s.\n",jogo.jogadores_equipaB[10],jogo.jogadores_equipaA[10]);
       sleep(3);
printf("\nCartão Amarelo - O árbitro mostra o cartão amarelo ao %s.\n",jogo.jogadores_equipaB[10]);
       sleep(3);
         jogo.cartao_amarelo++;
...
printf("\n81'	%s derruba %s.\n",jogo.jogadores_equipaB[10],jogo.jogadores_equipaA[7]);
       sleep(3);
printf("\nCartão Vermelho - O árbitro exibe o segundo amarelo ao %s e expulsa-o.\n",jogo.jogadores_equipaB[10],jogo.jogadores_equipaA[0]);
       sleep(3);
         jogo.cartao_vermelho++;
...
printf("\nGOLO!! - A bola saltita passando pelo guarda-redes e passa a linha.\n");
 ...
 printf("\n%s mergulha e faz uma grande defesa.\n",jogo.jogadores_equipaB[5]);
    sleep(3);
 printf("\n88'%s cai depois de uma falta de %s.\n",jogo.jogadores_equipaB[6],jogo.jogadores_equipaA[10]);
    sleep(3);
